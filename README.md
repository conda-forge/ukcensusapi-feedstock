About ukcensusapi-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ukcensusapi-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/virgesmith/UKCensusAPI
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5850&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ukcensusapi-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ukcensusapi` can be installed with `conda`:
...
```
mamba install ukcensusapi
```

It is possible to list all of the versions of `ukcensusapi` available on your platform with `conda`:
...
```
mamba search ukcensusapi --channel conda-forge
```
...
mamba repoquery search ukcensusapi --channel conda-forge

# List packages depending on `ukcensusapi`:
mamba repoquery whoneeds ukcensusapi --channel conda-forge

# List dependencies of `ukcensusapi`:
mamba repoquery depends ukcensusapi --channel conda-forge
```
